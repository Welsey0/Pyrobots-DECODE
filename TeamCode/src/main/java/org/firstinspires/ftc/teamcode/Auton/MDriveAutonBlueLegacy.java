// MDrive Auton Blue [Legacy, Do Not Run]
...
@Disabled
@Autonomous(name="Auton Blue [Legacy, Do Not Run]")
public class MDriveAutonBlueLegacy extends OpMode {
    private MDS mds;
    ...
    private String auton(String motorcode) {
        if (mds.auton.autonStep == 0) {
            ...
            return motorcode;
        } else if (mds.auton.autonStep == 2) { //not used for now
            ...
            if (mds.auton.firstOfStep) {
                ...
                if (mds.auton.autonIter < 3) {
                    Auton.targetHeading = -(3.1*3.1415) / 4; // blue
                    mds.auton.firstOfStep = false;
                    mds.auton.autonMoving = 1;
                }
            }
            ...
            if (mds.auton.firstOfStep) {
                ...
                Auton.moveTime = 1500; //expected time in millis
            }
            mds.otherControllers.muOn = 1;
            mds.otherControllers.intakeOn = 1;
